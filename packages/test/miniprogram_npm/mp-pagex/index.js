...
__DEFINE__(1547442915345, function(require, module, exports) {
"use strict";
...
var PageX = /** @class */ (function () {
    function PageX(options, mergeStrategy) {
        if (mergeStrategy === void 0) { mergeStrategy = mp_computed_1.mergeOptions; }
...
return __REQUIRE__(1547442915345);
})()
